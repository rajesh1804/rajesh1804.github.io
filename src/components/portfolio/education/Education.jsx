...
export default function Education(){
  return(
    <Card border="light" style={{backgroundColor: 'transparent'}} id="education">
      <Card.Header as="h1" style={{backgroundColor: 'rgb(217,242,254)'}}>🏫Education</Card.Header>
      <Card.Body>
        <Accordion flush>
          ...
          <Accordion.Item eventKey="1">
            <Accordion.Header><strong>B.Tech Computer Science and Engineering </strong> </Accordion.Header>
            <Accordion.Body>
